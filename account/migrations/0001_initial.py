    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inviter_token', models.CharField(blank=True, max_length=150, null=True)),
                ('last_action', models.DateTimeField(default=django.utils.timezone.now)),
                ('is_confirmed', models.BooleanField(default=False)),
                ('cents', models.BigIntegerField(default=0)),
                ('verify_code', models.CharField(blank=True, default='', max_length=100, null=True)),
                ('reset_password_code', models.CharField(blank=True, default='', max_length=100, null=True)),
